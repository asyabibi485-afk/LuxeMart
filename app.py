...
.stApp {
    background:
        radial-gradient(circle at 5% 5%, rgba(118,87,255,0.08), transparent 25%),
        radial-gradient(circle at 95% 10%, rgba(255,105,180,0.08), transparent 25%),
        linear-gradient(135deg, #ffffff, #faf8ff, #fff8fc);
    color: #18151e;
}
...
div.stButton > button {
    ...
    box-shadow: 0 4px 12px rgba(118,87,255,0.08);
...
.hero {
    ...
    border-radius: 30px;
    margin: 25px 0;
    background: linear-gradient(135deg, #eee8ff, #f9edff, #fff0f7);
    border: 1px solid #e8ddf7;
    box-shadow: 0 25px 60px rgba(118,87,255,0.12);
}
...
.product-card {
    ...
    padding: 18px;
    margin-bottom: 15px;
    box-shadow: 0 12px 35px rgba(30,20,50,0.06);
    transition: all 0.25s ease;
}

.product-card:hover {
    transform: translateY(-5px);
    box-shadow: 0 20px 45px rgba(30,20,50,0.11);
    border-color: #ded3f4;
}
...
.admin-box {
    ...
    padding: 30px;
    margin: 25px 0;
    box-shadow: 0 15px 40px rgba(118,87,255,0.09);
}
