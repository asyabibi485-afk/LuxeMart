...
st.markdown(
    ...
    .hero-box {
        ...
        box-shadow:
        0 15px 45px rgba(50, 40, 65, 0.08);
    }
    ...
    .product-card {
        ...
        box-shadow:
        0 10px 28px rgba(50,40,65,0.07);
        margin-bottom: 10px;
    }
            ...
            if not customer_name.strip():
                ...
                try:
                    ...
                    st.error(
                        ...
                        "Please check your order table columns."
                    )
        ...
        if st.button(
            ...
            if not email.strip():
                ...
                try:
                    ...
                    st.error(
                        "Admin login failed. "
                        "Please check your Supabase email and password."
                    )
...
st.write("📞 03169707804")
st.write("✉️ asyabibi485@gmail.com")
st.caption("© 2026 LUXEMART. All rights reserved.")
