...
with st.sidebar:
    ...
    st.markdown(
        ...
        ">
            <b>🛍️ LUXEMART</b><br>
            <small>
            Fashion • Beauty • Jewellery • Perfume
            </small>
        </div>
        """,
        unsafe_allow_html=True
...
if st.session_state.page == "Shop":
    ...
    slider_button1, slider_button2, slider_button3 = st.columns(
        [1, 2, 1]
    )
    ...
    # Clear sidebar selection after reading it
    if "sidebar_category" in st.session_state:
        if category != st.session_state.sidebar_category:
            st.session_state.sidebar_category = category
